 ...
 *  Maintainers: Remember_the_dot, Interiot, Mets501, Freakofnurture
 */
...
if (wgIsArticle) //prevents the "Editing " prefix from disappearing during preview
{
    addOnloadHook(function()
    {
        ...
        if (realTitle)
        {
            ...
            {
                var indexOfColon = realTitleText.indexOf(":")
                var realPageTitle = realTitleText.substring(indexOfColon + 1)
                var normalizedRealPageTitle = normalizeTitle(realPageTitle)
