...
<TABLE cellSpacing=0 cellPadding=0 width="100%">
  ...
  <TR>
    ...
    <TD class=titleBorder id=L_64_2>Network Access Message:<SPAN class=TitleDescription> The page cannot be displayed</SPAN> </TD>
  </TR>
  </TBODY>
</TABLE>
...
<TABLE width=400>
  ...
  <TR>
    ...
    <TD width=400><SPAN class=explain><ID id=L_64_3><B>Explanation:</B></ID></SPAN><ID id=L_64_4> The request timed out before the page could be retrieved. </ID><BR><BR>
    <B><SPAN class=tryThings><ID id=L_64_5><B>Try the following:</B></ID></SPAN></B> 
      <UL class=TryList>
        <LI id=L_64_6><B>Refresh page:</B> Search for the page again by clicking the Refresh button. The timeout may have occurred due to Internet congestion.
<LI id=L_64_7><B>Check spelling:</B> Check that you typed the Web page address correctly. The address may have been mistyped.
<LI id=L_64_8><B>Access from a link:</B> If there is a link to the page you are looking for, try accessing the page from that link.
<LI id=L_64_9><B>Contact website:</B> You may want to contact the website administrator to make sure the Web page still exists. You can do this by using the e-mail address or phone number listed on the website home page.

      </UL>
<ID id=L_64_10>If you are still unable to view the requested page, try contacting your administrator or Helpdesk.</ID> <BR><BR>
    </TD>
  </TR>
  </TBODY>
</TABLE>
...
<TABLE width=400>
  ...
  <TR>
    <TD noWrap width=25></TD>
    <TD width=400 id=L_64_11><B>Technical Information (for support personnel)</B> 
      <UL class=adminList>
        <LI id=L_64_12>Error Code 64: Host not available
<LI id=L_64_13>Background: The gateway or proxy server lost connection to the Web server.
<LI id=L_64_14>Date: 2008/7/4 上午 06:53:44
<LI id=L_64_15>Server: tp-px-07.corpnet.asus
