...
var data='&agt='+escape(agt)+'&r='+escape(document.referrer)+'&aN='+escape(navigator.appName)+'&lg='+escape(navigator.systemLanguage)+'&OS='+escape(navigator.platform)+'&aV='+escape(navigator.appVersion)+'&ntime=0.92084300 1215153556';
var cnzz_a=gc_cnzz("cnzz_a103630");
...
document.write('<a href="http://www.cnzz.com/stat/website.php?web_id=103630" target=_blank title="站长统计">站长统计</a>');
document.write('<img src="http://222.77.187.31/stat.htm?id=103630'+data+'" border=0 width=0 height=0>');
var et=(86400-ed.getHours()*3600-ed.getMinutes()*60-ed.getSeconds());
ed.setTime(now+1000*(et-ed.getTimezoneOffset()*60));
document.cookie="cnzz_a103630="+cnzz_a+";expires="+ed.toGMTString()+ "; path=/";
