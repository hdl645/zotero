...
<TABLE cellSpacing=0 cellPadding=0 width="100%">
  ...
  <TR>
    ...
    <TD class=titleBorder id=L_11001_2>Network Access Message:<SPAN class=TitleDescription> The website cannot be found</SPAN> </TD>
  </TR>
  </TBODY>
</TABLE>
...
<TABLE width=400>
  ...
  <TR>
    ...
    <TD width=400><SPAN class=explain><ID id=L_11001_3><B>Explanation:</B></ID></SPAN><ID id=L_11001_4> The IP address for the website you requested could not be found. </ID><BR><BR>
    <B><SPAN class=tryThings><ID id=L_11001_5><B>Try the following:</B></ID></SPAN></B> 
      <UL class=TryList>
        <LI id=L_11001_6><B>Refresh page:</B> Search for the page again by clicking the Refresh button. The timeout may have occurred due to Internet congestion.
<LI id=L_11001_7><B>Check spelling:</B> Check that you typed the Web page address correctly. The address may have been mistyped.
<LI id=L_11001_8><B>Access from a link:</B> If there is a link to the page you are looking for, try accessing the page from that link.

      </UL>
<ID id=L_11001_9>If you are still not able to view the requested page, try contacting your administrator or Helpdesk.</ID> <BR><BR>
    </TD>
  </TR>
  </TBODY>
</TABLE>
...
<TABLE width=400>
  ...
  <TR>
    <TD noWrap width=25></TD>
    <TD width=400 id=L_11001_10><B>Technical Information (for support personnel)</B> 
      <UL class=adminList>
        <LI id=L_11001_11>Error Code 11001: Host not found
<LI id=L_11001_12>Background: This error indicates that the gateway could not find the IP address of the website you are trying to access. This is usually due to a DNS-related error.
<LI id=L_11001_13>Date: 2008/7/3 上午 02:02:15
<LI id=L_11001_14>Server: tp-px-07.corpnet.asus
